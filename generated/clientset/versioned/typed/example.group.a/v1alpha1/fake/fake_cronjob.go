...
var cronjobsResource = schema.GroupVersionResource{Group: "example.group.a", Version: "v1alpha1", Resource: "cronjobs"}

var cronjobsKind = schema.GroupVersionKind{Group: "example.group.a", Version: "v1alpha1", Kind: "CronJob"}
...
func (c *FakeCronJobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(cronjobsResource, c.ns, name, opts), &v1alpha1.CronJob{})
