...
// ExampleV1alpha1Client is used to interact with features provided by the example.group.a group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) CronJobs(namespace string) CronJobInterface {
