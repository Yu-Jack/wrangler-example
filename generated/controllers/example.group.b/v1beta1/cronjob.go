...
func (c *cronJobController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.CronJob, error) {
	result := &v1beta1.CronJob{}
...
func (c *cronJobCache) List(namespace string, selector labels.Selector) (ret []*v1beta1.CronJob, err error) {
...
func (c *cronJobCache) GetByIndex(indexName, key string) (result []*v1beta1.CronJob, err error) {
	...
	result = make([]*v1beta1.CronJob, 0, len(objs))
